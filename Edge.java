...
public class Edge {
    ...
    public void draw( Line l)
    {
        ...
        {
            switch (occupColor){
                    case 1: l.setFill(Color.RED); break;
                    case 2: l.setFill(Color.PURPLE); break;
                    case 3: l.setFill(Color.GREEN); break;
                    case 4: l.setFill(Color.BLUE); break;
                    default: l.setFill(Color.BLACK); break;
            }
        }
